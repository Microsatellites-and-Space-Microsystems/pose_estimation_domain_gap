...
from .ape import AbsoluteEmbedding
from .basic import BasicLayer
from .embed import PatchEmbedding
from .merge import PatchMerging
from .norm import LayerNorm

BASE_URL = 'https://github.com/Microsatellites-and-Space-Microsystems/pose_estimation_domain_gap/releases/download/1.0.1/swin_{}.h5'
WEIGHT_URLS = {
