#Code adapted from https://github.com/sebastian-sz/efficientnet-lite-keras
...
WEIGHTS_BASE_URL = (
    "https://github.com/Microsatellites-and-Space-Microsystems/pose_estimation_domain_gap/releases/download/1.0.2/"
)
WEIGHTS_HASHES = {
...
def EfficientNetLite(
    ...
    x = layers.experimental.SyncBatchNormalization(axis=bn_axis, name="stem_bn")(x)
    ...
    x = layers.experimental.SyncBatchNormalization(axis=bn_axis, name="top_bn")(x)
...
def block(
    ...
    if expand_ratio != 1:
        ...
        x = layers.experimental.SyncBatchNormalization(axis=bn_axis, name=name + "expand_bn")(x)
    ...
    x = layers.experimental.SyncBatchNormalization(axis=bn_axis, name=name + "bn")(x)
    ...
    x = layers.experimental.SyncBatchNormalization(axis=bn_axis, name=name + "project_bn")(x)
