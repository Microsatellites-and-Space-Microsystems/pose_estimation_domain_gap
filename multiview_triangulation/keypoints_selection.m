...
%KEYPOINTS_SELECTION Manually select pre-defined keypoints on a set of
%images and store coordinates
%   [image_points, poses]=keypoints_selection(selected_images) allows to
%   retrieve and store the coordinates of some pre-defined keypoints by manually
...
%           - pos:      position vector of the satellite [m]
%
